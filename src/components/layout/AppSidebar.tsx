...
const AppSidebar = () => {
  ...
  useEffect(() => {
    authService
      ...
      .catch((error) => console.error("Erro ao buscar utilizador:", error));
  }, []);
  ...
  // Define role default caso usuário ainda não tenha carregado
  ...
  return (
    ...
    >
      ...
      <div className="p-3 border-t border-sidebar-border">
        <button onClick={handleLogout} className="sidebar-item text-red-500 w-full">
